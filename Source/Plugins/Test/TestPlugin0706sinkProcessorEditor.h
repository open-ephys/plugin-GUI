...
#ifndef TESTPLUGIN0706SINKPROCESSOREDITOR_H_INCLUDED
#define TESTPLUGIN0706SINKPROCESSOREDITOR_H_INCLUDED
...
class TestPlugin0706sinkProcessorEditor : public GenericEditor	//Generic Editor adds listeners for buttons and sliders. 
...
public:
    ...
    TestPlugin0706sinkProcessorEditor (GenericProcessor* parentNode, bool useDefaultParameterEditors);

    /** The class destructor, used to deallocate memory */
    ~TestPlugin0706sinkProcessorEditor();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TestPlugin0706sinkProcessorEditor);
};

#endif // TESTPLUGIN0706SINKPROCESSOREDITOR_H_INCLUDED

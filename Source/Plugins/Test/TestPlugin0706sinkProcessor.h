...
#ifndef TESTPLUGIN0706SINKPROCESSOR_H_INCLUDED
#define TESTPLUGIN0706SINKPROCESSOR_H_INCLUDED
...
class TestPlugin0706sinkProcessor : public GenericProcessor

{
public:
    /** The class constructor, used to initialize any members. */
    TestPlugin0706sinkProcessor();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TestPlugin0706sinkProcessor);
};


#endif  // TESTPLUGIN0706SINKPROCESSOR_H_INCLUDED

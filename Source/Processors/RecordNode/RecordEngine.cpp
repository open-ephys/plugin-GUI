...
void RecordEngine::setChannelMapping(const Array<int>& chans, const Array<int>& chanProc, const Array<int>& chanOrder, const OwnedArray<RecordProcessorInfo>& processors)
{
	channelMap = chans;
